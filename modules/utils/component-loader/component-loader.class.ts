...
export class ComponentLoader<T> {
  ...
  public show(opts: { content?: string | TemplateRef<any>; [key: string]: any } = {}): ComponentRef<T> {
    ...
    if (!this._componentRef) {
      ...
      if (this.container === 'body' && typeof document !== 'undefined') {
        document.querySelector(this.container as string).appendChild(this._componentRef.location.nativeElement);
      }
  ...
  public listen(listenOpts: ListenOptions): ComponentLoader<T> {
    ...
    listenOpts.toggle = listenOpts.toggle || (() => (this.isShown ? listenOpts.hide() : listenOpts.show()));
