...
export class BsDropdownToggleDirective implements OnDestroy {
  ...
  constructor(private _state: BsDropdownState, private _element: ElementRef) {
    ...
    this._subscriptions.push(this._state.isOpenChange.subscribe((value: boolean) => (this.isOpen = value)));
    // populate disabled state
    this._subscriptions.push(
      this._state.isDisabledChange.subscribe((value: boolean) => (this.isDisabled = value || null))
    );
  }
